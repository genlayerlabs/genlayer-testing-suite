from gltest.types import MockedLLMResponse, MockedWebRequest
...
class Validator:
    ...
    mock_web_request: Optional[MockedWebRequest]
    ...
    def clone(self) -> "Validator":
        return Validator(
            ...
            mock_web_request=deepcopy(self.mock_web_request),
        )
...
class ValidatorFactory:
    ...
    def create_mock_validator(
        ...
        mock_web_request: Optional[MockedWebRequest] = None,
    ) -> Validator:
        ...
        return Validator(
            ...
            mock_web_request=(
                deepcopy(mock_web_request) if mock_web_request is not None else None
            ),
        )
    ...
    def batch_create_mock_validators(
        ...
        return [
            self.create_mock_validator(mock_llm_response, mock_web_request)
            for _ in range(count)
        ]
